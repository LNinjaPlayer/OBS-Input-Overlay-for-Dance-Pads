...
**3)** In the **URL** box, enter the path to where you put **index.html**, **texture.png** must also be there<br>
...
To do so, from the preset's .json, copy everthing into **const preset** at line 50 of **index.html** (inbetween = and ; )<br>
